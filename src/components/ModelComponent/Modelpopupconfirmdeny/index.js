...
const ModelconfirmdenyComponent = ({ setStartdata,setFinaldata,handledenyuser,showModalConfirmDenyRider,setShowModalConfirmDenyRider,userId,userName,pagesize}) => {

    return (
        <>
            {showModalConfirmDenyRider ? (
                <>
                    <div
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="flex items-start justify-between p-4 border-b border-solid border-slate-200 rounded-t">
                                    <h3 className="text-xl font-semibold">
                                        {constant.ModelconfirmdenyContent.title}
                                    </h3>
                                    <button
                                        ...
                                        onClick={() => setShowModalConfirmDenyRider(false)}
                                    >
                                    </button>
                                </div>
                                {/*body*/}
                                <div className="relative p-6 flex-auto min-w-[500px]">
                                    ...
                                    {constant.ModelconfirmdenyContent.des[0]} <span className="text-black">{userId}</span> <br />
                                    {constant.ModelconfirmdenyContent.des[1]} <span className="text-black">{userName || userId}</span> {constant.ModelconfirmdenyContent.des[2]}
                                    </p>
                                </div>
                                {/*footer*/}
                                <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                                    <button
                                        ...
                                        onClick={() => setShowModalConfirmDenyRider(false)}
                                    >
                                        {constant.ModelconfirmdenyContent.buttonclose}
                                    </button>
                                    <button
                                        ...
                                        onClick={(e)=> {
                                            ...
                                            handledenyuser(e, userId)}}
                                    >
                                        {constant.ModelconfirmdenyContent.buttonsubmit}
                                    </button>
                                </div>
                            </div>
                        </div>
...
export default ModelconfirmdenyComponent